...
public class ExperimentSpecParser {
  ...
  public static final String DEFAULT_S3_ENDPOINT_URL = "http://submarine-minio-service:9000";
  ...
  private static List<V1EnvVar> parseEnvVars(Map<String, String> envMap) {
    ...
    envVars.add(
        new V1EnvVar().name(MLFLOW_S3_ENDPOINT_URL).value(DEFAULT_S3_ENDPOINT_URL)
    );
