...
from submarine.client import rest
from submarine.client.configuration import Configuration
from submarine.client.exceptions import ApiException, ApiTypeError, ApiValueError
from submarine.client.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    def __init__(
        self, settings=None, params_map=None, root_map=None, headers_map=None, api_client=None, callable=None
    ):
        """Creates an endpoint
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EnvironmentApi()
        api_instance.create_environment  # this is an instance of the class Endpoint
        api_instance.create_environment()  # this invokes api_instance.create_environment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_environment.callable or self.callable in this class
