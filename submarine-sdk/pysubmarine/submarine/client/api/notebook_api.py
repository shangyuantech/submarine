...
class NotebookApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_notebook_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/notebook/{id}',
        ...
        self.get_notebook_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/notebook/{id}',
        ...
        self.list_notebooks_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/notebook',
        ...
        self.ping2_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [],
                'endpoint_path': '/v1/notebook/ping',
                'operation_id': 'ping2',
                'http_method': 'GET',
                'servers': None,
            },
    ...
    def create_notebook(self, **kwargs):
        ...
        Keyword Args:
            notebook_spec (NotebookSpec): [optional]
    ...
    def delete_notebook(self, id, **kwargs):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['id'] = id
        return self.delete_notebook_endpoint.call_with_http_info(**kwargs)

    def get_notebook(self, id, **kwargs):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['id'] = id
        return self.get_notebook_endpoint.call_with_http_info(**kwargs)
    ...
    def list_notebooks(self, **kwargs):
        ...
        kwargs['_content_type'] = kwargs.get('_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_notebooks_endpoint.call_with_http_info(**kwargs)
    ...
    def ping2(self, **kwargs):
        ...
        kwargs['_content_type'] = kwargs.get('_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.ping2_endpoint.call_with_http_info(**kwargs)
