...
class ExperimentTemplatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.delete_experiment_template_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/template/{id}',
                'operation_id': 'delete_experiment_template',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
        ...
        self.list_experiment_template_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/template',
                'operation_id': 'list_experiment_template',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_experiment_template_endpoint = _Endpoint(
            settings={
                'response_type': (JsonResponse,),
                'auth': [],
                'endpoint_path': '/v1/template/{id}',
                'operation_id': 'update_experiment_template',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def delete_experiment_template(self, id, **kwargs):
        ...
        kwargs['id'] = id
        return self.delete_experiment_template_endpoint.call_with_http_info(**kwargs)

    def list_experiment_template(self, **kwargs):
        ...
        kwargs['_content_type'] = kwargs.get('_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.list_experiment_template_endpoint.call_with_http_info(**kwargs)

    def update_experiment_template(self, id, **kwargs):
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['id'] = id
        return self.update_experiment_template_endpoint.call_with_http_info(**kwargs)
